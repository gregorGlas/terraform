...
func TestTest(t *testing.T) {
	...
	runner := TestSuiteRunner{
		...
		Schemas:          nil, // We don't need this for this test.
...
func TestTest_JSON(t *testing.T) {
	...
	output := done(t)
	actual := output.All()
	expected := `{"@level":"info","@message":"Terraform 1.6.0-dev","@module":"terraform.ui","@timestamp":"2023-08-21T10:52:15.070516+02:00","terraform":"1.6.0-dev","type":"version","ui":"1.2"}
{"@level":"info","@message":"Found 1 file and 2 run blocks","@module":"terraform.ui","@timestamp":"2023-08-21T10:52:15.081492+02:00","test_abstract":{"main.tftest.hcl":["defaults","overrides"]},"type":"test_abstract"}
{"@level":"info","@message":"main.tftest.hcl... pass","@module":"terraform.ui","@testfile":"main.tftest.hcl","@timestamp":"2023-08-21T10:52:15.326316+02:00","test_file":{"path":"main.tftest.hcl","status":"pass"},"type":"test_file"}
{"@level":"info","@message":"  \"defaults\"... pass","@module":"terraform.ui","@testfile":"main.tftest.hcl","@testrun":"defaults","@timestamp":"2023-08-21T10:52:15.326362+02:00","test_run":{"path":"main.tftest.hcl","run":"defaults","status":"pass"},"type":"test_run"}
{"@level":"info","@message":"  \"overrides\"... pass","@module":"terraform.ui","@testfile":"main.tftest.hcl","@testrun":"overrides","@timestamp":"2023-08-21T10:52:15.326371+02:00","test_run":{"path":"main.tftest.hcl","run":"overrides","status":"pass"},"type":"test_run"}
{"@level":"info","@message":"Success! 2 passed, 0 failed.","@module":"terraform.ui","@timestamp":"2023-08-21T10:52:15.448244+02:00","test_summary":{"status":"pass","passed":2,"failed":0,"errored":0,"skipped":0},"type":"test_summary"}
`
...
func TestTest_Verbose(t *testing.T) {
	...
	schemas := &terraform.Schemas{
		Providers: map[addrs.Provider]providers.ProviderSchema{
			addrs.NewDefaultProvider("tfcoremock"): {
...
Terraform will perform the following actions:
  ...
  # tfcoremock_simple_resource.resource will be created
...
resource "tfcoremock_simple_resource" "resource" {
    id     = "e225e1b6-52ab-d0b4-d08b-4b166da842f2"
...
`
	...
	if tr.Status != tfe.TestRunStatusCancelled {
...
Terraform was in the process of creating the following resources for "" from
the module under test, and they may not have been destroyed:
